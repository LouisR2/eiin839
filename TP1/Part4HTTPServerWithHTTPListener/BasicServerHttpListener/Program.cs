...
{
    internal class Header   //TODO DELETE USELESS
    {
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                header.printHeaders();  //To display all request headers in console
                ...
                string responseString = "<h1>Voici les headers de votre requete :</h1><br/><pre>" + header.getHeaders().ToString() + "</pre>";
